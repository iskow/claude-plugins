...
- **qc-gate** — the final QC check before any deliverable ships: contract, traceability, zero typos, flag-don't-guess.
- **client-intake** — onboards a new client: interviews Joel, fills the client-profile template, saves it to `clients/`.
